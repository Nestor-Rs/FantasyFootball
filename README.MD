...
You need data of group data to use that neural network:
...
In code, is class and has constructor receive an input list and a weight list .
...
using the data of data file, the simulation set that's result:
